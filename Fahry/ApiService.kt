...
interface ApiService {
    ...
    fun createPlotting(
            @Field("dsn_nip") mhs_nim: String?,
            @Field("tugas_akhir_id") tugas_akhir_id: Int,
            @Field("plotting_status") plotting_status: String,
            @Field("plotting_tanggal") plotting_tanggal: String,
            @Field("plotting_waktu") plotting_waktu: String,
            @Field("plotting_ruang") plotting_ruang: String,

    ): Call<Plotting?>?

    @GET(FinproUrl.URL_PLOTTING + FinproUrl.PATH_SEARCH + FinproUrl.PATH_ALL + FinproUrl.BASE_PARAMETER + FinproUrl.PARAMETER_QUERY)
    fun searchDosenBimbinganBy(
        @Path(FinproUrl.VAR_PARAMS) parameter: String?,
        @Path(FinproUrl.VAR_QUERY) query: String?
    ): Call<List<Plotting?>?>?

    @GET(FinproUrl.URL_PLOTTING + FinproUrl.PATH_SEARCH + FinproUrl.PATH_ALL + "/penguji"+ FinproUrl.BASE_PARAMETER + FinproUrl.PARAMETER_QUERY)
    fun searchDosenPengujiBy(
            @Path(FinproUrl.VAR_PARAMS) parameter: String?,
            @Path(FinproUrl.VAR_QUERY) query: String?
    ): Call<List<Plotting?>?>?
    ...
    fun createBimbingan(
            ...
            @Field("plotting_id") plotting_id: Int
    ): Call<Bimbingan?>?
...
//    fun deleteKegiatan(@Path(FinproUrl.VAR_KEGIATAN) kegiatan_id: Int): Call<Kegiatan?>?
    ...
    // ---------------------------------------------------------------------------------------------
    @FormUrlEncoded
    @POST(FinproUrl.URL_LAAK)
    fun createLaak(
        @Field("laak_nip") laak_nip: String?,
        @Field("laak_nama") laak_nama: String?,
        @Field("laak_kode") laak_kode: String?
    ): Call<Laak?>?

    @FormUrlEncoded
    @POST(FinproUrl.URL_LAAK + FinproUrl.PATH_UPDATE + FinproUrl.PARAMETER_LAAK)
    fun updateLaak(
        @Path(FinproUrl.VAR_LAAK) username: String?,
        @Field("laak_nip") laak_nip: String?,
        @Field("laak_nama") laak_nama: String?,
        @Field("laak_kode") laak_kode: String?,
        @Field("laak_kontak") laak_kontak: String?,
        @Field("laak_email") laak_email: String?
    ): Call<Laak?>?

    @GET(FinproUrl.URL_LAAK)
    fun getLaak(): Call<List<Laak?>?>?

    @POST(FinproUrl.URL_LAAK + FinproUrl.PATH_DELETE + FinproUrl.PARAMETER_LAAK)
    fun deleteLaak(@Path(FinproUrl.VAR_LAAK) laak_nip: String?): Call<Laak?>?

    @GET(FinproUrl.URL_LAAK + FinproUrl.PARAMETER_LAAK)
    fun getLaakByParameter(@Path(FinproUrl.VAR_LAAK) username_laak: String?): Call<Laak?>?
...
//    fun deleteKuotaDosen(@Path(FinproUrl.VAR_KUOTA_DOSEN) kuota_id: Int): Call<KuotaDosen?>?
    ...
    fun updateMahasiswa(
            ...
            @Field("mhs_kontak") mhs_kontak: String?,
            @Field("mhs_email") mhs_email: String?,
            @Field("sks_lulus") sks_lulus: Int?,
            @Field("sks_tidak_lulus") sks_tidak_lulus: Int?
    ): Call<Mahasiswa?>?
...
//    ): Call<List<DetailMonev?>?>?
    ...
    // Tugas Akhir
    // ---------------------------------------------------------------------------------------------
    @GET(FinproUrl.URL_TUGAS_AKHIR)
    fun getTugasAkhir(): Call<List<TugasAkhir?>?>?

    @GET(FinproUrl.URL_TUGAS_AKHIR + FinproUrl.PATH_SEARCH + FinproUrl.PATH_ALL + FinproUrl.BASE_PARAMETER + FinproUrl.PARAMETER_QUERY)
    fun getsearchTugasAkhirBy(
        @Path(FinproUrl.VAR_PARAMS) parameter: String?,
        @Path(FinproUrl.VAR_QUERY) query: String?
    ): Call<List<TugasAkhir?>?>?

    @GET(FinproUrl.URL_TUGAS_AKHIR + FinproUrl.PATH_SEARCH + FinproUrl.PATH_ALL + "/penguji"+FinproUrl.BASE_PARAMETER + FinproUrl.PARAMETER_QUERY)
    fun getsearchPengujiBy(
            @Path(FinproUrl.VAR_PARAMS) parameter: String?,
            @Path(FinproUrl.VAR_QUERY) query: String?
    ): Call<List<TugasAkhir?>?>?
    ...
    fun createSidang(
            @Field("periode_id") periode_id: Int?,
            @Field("draft_ta") draft_ta: String?,
            @Field("tugas_akhir_id") tugas_akhir_id: Int
    ): Call<Sidang?>?
...
//            @Field("sidang_status") sidang_status: String?
    ...
    // Nilai Sidang
    // ---------------------------------------------------------------------------------------------
    @GET(FinproUrl.URL_NILAI_SIDANG)
    fun getNilaiSidang(): Call<List<NilaiSidang?>?>?

    @FormUrlEncoded
    @POST(FinproUrl.URL_NILAI_SIDANG)
    fun createNilaiSidang(
            @Field("sidang_tanggal") sidang_tanggal: String?,
            @Field("sidang_pukul") sidang_pukul: String?,
            @Field("sidang_ruang") sidang_ruang: String?,
            @Field("pemb1_clo1") pemb1_clo1: String?,
            @Field("pemb1_clo2") pemb1_clo2: String?,
            @Field("pemb1_clo3") pemb1_clo3: String?,
            @Field("pemb2_clo1") pemb2_clo1: String?,
            @Field("pemb2_clo2") pemb2_clo2: String?,
            @Field("pemb2_clo3") pemb2_clo3: String?,
            @Field("peng1_clo1") peng1_clo1: String?,
            @Field("peng1_clo2") peng1_clo2: String?,
            @Field("peng1_clo3") peng1_clo3: String?,
            @Field("peng2_clo1") peng2_clo1: String?,
            @Field("peng2_clo2") peng2_clo2: String?,
            @Field("peng2_clo3") peng2_clo3: String?,
            @Field("total_nilai") total_nilai: Double,
            @Field("indeks") indeks: String?,
            @Field("batas_revisi") batas_revisi: String?,
            @Field("sidang_status") sidang_status: String?,
            @Field("catatan_revisi") catatan_revisi: String?,
            @Field("tugas_akhir_id") tugas_akhir_id: Int
    ): Call<NilaiSidang?>?

    @FormUrlEncoded
    @POST(FinproUrl.URL_NILAI_SIDANG + FinproUrl.PATH_UPDATE + FinproUrl.PARAMETER_NILAI_SIDANG)
    fun updateNilaiSidang(
            @Path(FinproUrl.VAR_NILAI_SIDANG) sidang_nilai_id: Int?,
            @Field("sidang_tanggal") sidang_tanggal: String?,
            @Field("sidang_pukul") sidang_pukul: String?,
            @Field("sidang_ruang") sidang_ruang: String?,
            @Field("pemb1_clo1") pemb1_clo1: String?,
            ...
            @Field("indeks") indeks: String?,
            @Field("batas_revisi") batas_revisi: String?,
            @Field("justifikasi") justifikasi: String?,
            @Field("sidang_status") sidang_status: String?,
            @Field("catatan_revisi") catatan_revisi: String?

    ): Call<NilaiSidang?>?

    @GET(FinproUrl.URL_NILAI_SIDANG + FinproUrl.PATH_SEARCH + FinproUrl.PATH_ALL + FinproUrl.BASE_PARAMETER + FinproUrl.PARAMETER_QUERY)
    fun searchAllNilaiSidangBy(
            @Path(FinproUrl.VAR_PARAMS) parameter: String?,
            @Path(FinproUrl.VAR_QUERY) query: String?
    ): Call<List<NilaiSidang?>?>?
